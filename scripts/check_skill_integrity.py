...
REQUIRED = (
    ...
    "scripts/check_immutable_set.py",
    "scripts/check_pass_scope.py",
    "scripts/check_claim_strength.py",
    "scripts/check_terminology_freeze.py",
    "scripts/check_wiring_integrity.py",
    "scripts/check_reference_reachability.py",
