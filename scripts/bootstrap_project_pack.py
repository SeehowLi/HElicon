...
def main() -> int:
    ...
    files = {
        ...
        "claim_ledger.md": "# Claim Ledger\n\n## Current Locked Claims\n\n- Claim ID:\n  - Claim:\n  - Scope:\n  - Evidence status: SUPPORTED / PARTIAL / MISSING / RISKY / UNKNOWN\n  - Safe wording:\n  - Unsafe wording:\n  - Evidence links:\n  - Active reviewer risks:\n  - Last synced:\n\n## Open Or Conditional Claims\n\n## Superseded Claims\n",
        "evidence_matrix.csv": "claim_id,section_or_claim,evidence_type,evidence_source,status,gap,risk,next_action,last_synced\nC1,,,,UNKNOWN,,,,\n",
        "revision_queue.csv": "task_id,priority,source,section,target_claim,problem,action,status,blocked_by,next_command,last_synced\nR1,high,,,,,,OPEN,,,\n",
        "reviewer_risk_log.md": "# Reviewer Risk Log\n\n## Active Risks\n\n- Risk ID:\n  - Severity: high / medium / low\n  - Likely reviewer concern:\n  - Affected claim or section:\n  - Evidence status:\n  - Why reviewer cares:\n  - Mitigation:\n  - Revision queue link:\n  - Status: OPEN / MITIGATED / ACCEPTED_LIMITATION\n  - Last synced:\n\n## Resolved Or Archived Risks\n",
